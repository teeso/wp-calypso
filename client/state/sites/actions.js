	...
	return dispatch => {
		...
		return wpcom
			...
			.sites( {
				...
				fields:
					'ID,URL,name,capabilities,jetpack,visible,is_private,is_vip,icon,plan,jetpack_modules,single_user_site,is_multisite,options,lang,post_count', //eslint-disable-line max-len
				options:
